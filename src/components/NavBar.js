     ...
     <button className='flex-col items-center justify-center hidden lg:flex' onClick={handleClick}>
...

      {
        ...
        <motion.div
          ...
          className='min-w-[70vw] flex flex-col justify-between items-center bg-dark/90
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <button 
              onClick={() => setMode(mode === "light" ? "dark" : "light")} 
              className={'ml-1 sm:ml-1 flex items-center justify-center rounded-full p-1 ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}'}
              > 
              {
                mode === "dark" ? <SunIcon className={"fill-dark"} />
                : <MoonIcon className={"fill-dark"} />

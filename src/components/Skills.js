  ...
  return (
    <motion.div 
      className="flex items-center justify-center rounded-full font-semibold bg-dark dark:bg-light 
              text-light dark:text-dark py-3 px-6 shadow-dark cursor-pointer absolute"
  ...
  return (
    ...
    <div className='flex items-center justify-center w-full h-screen relative 
      ...
      <motion.div className="flex items-center justify-center rounded-full 
       font-semibold bg-dark dark:bg-light text-light dark:text-dark p-8 shadow-dark cursor-pointer"
       whileHover={{scale: 1.05}}>
        web
      </motion.div>
      ...
      <Skill name="Gatsby" x="13vw" y="-2vw" />
